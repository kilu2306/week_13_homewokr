...
//*************************** Action Methods ***************************************//
    ...
    //------------------------------------------------before and after filter product list --------------------
    public String beforFilteringZtoA(By by) {
        String productList = "";
        List<WebElement> beforeFilterList = driver.findElements(by);
        List<String> beforeFilter = new ArrayList<>();
        for (WebElement value : beforeFilterList) {
            productList = value.getText();
        }
        Collections.sort(beforeFilter, Collections.reverseOrder());
        return productList;
    }

    public String afterFilteringZtoA(By by) {
        String productList = "";
        List<WebElement> afterFilterList = driver.findElements(by);
        List<String> afterFilter = new ArrayList<>();
        for (WebElement value : afterFilterList) {
            productList = (value.getText());
        }
        return productList;
    }
//-------------------------------------------------before and after price list ----------------------------------------------------

    public List<Double> beforFilterPriceList(By by) {

        List<WebElement> beforepricelists = driver.findElements(by);
        ...
        return beforFilterprodcutprice;
    }

    public List<Double> afterFilterProductPriceList(By by) {

        List<WebElement> afterpicelists = driver.findElements(by);
        //converting in double
